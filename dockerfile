from php:apache
RUN apt-get update && apt-get install -y libc-client-dev libkrb5-dev libxml2-dev libbz2-dev zlib1g-dev libpng-dev libicu-dev libldap2-dev && rm -r /var/lib/apt/lists/*
